...
# Configuration - Replace with your actual AWS API Gateway details
API_ENDPOINT = "https://ikh1sc3052.execute-api.us-east-2.amazonaws.com/default/"
API_KEY = "uLvKjXwS1B0uAXh7Uteu6dOJWyCerhx5GW2lrZ64" # It is safer to use os.getenv('VITALS_API_KEY')
